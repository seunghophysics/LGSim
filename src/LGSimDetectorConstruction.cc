...
{    
    ...
    G4RotationMatrix rotAlSide; rotAlSide.rotateX(270.*deg); rotAlSide.rotateZ(180.*deg); G4ThreeVector vAlSide(0, 0, -.1*mm);
    G4VPhysicalVolume* alSidePV = new G4PVPlacement(G4Transform3D(rotAlSide, vAlSide), "AlSidePV", alSideLV, worldPV, false, 0, true);
    //                                                                                                                                                                      
    // Lead-glass block
    ...
    G4VPhysicalVolume* lgBoxPV = new G4PVPlacement(G4Transform3D(rotLGBox, vLGBox), "LGBoxPV", lgBoxLV, alSidePV, false, 0, true);
    //
    // light guide
